...
sed -i "s/EXTIP: \"[^\"]*\"/EXTIP: \"$EXT_IP\"/" docker-compose2.yml
sed -i "s/FEE_RECIPIENT: \"[^\"]*\"/FEE_RECIPIENT: \"$VALIDATOR_MINER_FEE_ADDRESS\"/" docker-compose2.yml
sed -i "s/HOST_IP: [^ ]*/HOST_IP: $EXT_IP/" docker-compose2.yml
sed -i "s/PEER_IP_LIST: [^ ]*/PEER_IP_LIST: $PEER_IP_LIST/" docker-compose2.yml
sed -i "s/ENV_BEACON_RPC: [^ ]*/ENV_BEACON_RPC: $ENV_BEACON_RPC/" docker-compose2.yml
